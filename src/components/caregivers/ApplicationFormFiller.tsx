...
const APPLICATION_FIELDS: FormFieldDef[] = [
  ...
  { id: "legal_name", label: "Legal Name", type: "text", page: 1, xPct: 0.1503, yPct: 0.69, section: "Application", tags: ["name_primary"], profileField: "full_name", fontSize: 10 },
  { id: "aliases", label: "Aliases", type: "text", page: 1, xPct: 0.6209, yPct: 0.69, section: "Application", fontSize: 10 },
  { id: "p1_address", label: "Address", type: "text", page: 1, xPct: 0.1225, yPct: 0.6585, section: "Application", profileField: "full_address", fontSize: 10 },
  { id: "home_phone", label: "Home Phone", type: "text", page: 1, xPct: 0.1601, yPct: 0.6269, section: "Application", profileField: "phone", fontSize: 10 },
  { id: "cell_phone", label: "Cell Phone", type: "text", page: 1, xPct: 0.4412, yPct: 0.6269, section: "Application", profileField: "phone", fontSize: 10 },
  { id: "p1_email", label: "Email", type: "text", page: 1, xPct: 0.7092, yPct: 0.6269, section: "Application", profileField: "email", fontSize: 10 },
  { id: "ssn", label: "Social Security Number", type: "text", page: 1, xPct: 0.2533, yPct: 0.5802, section: "Application", tags: ["ssn_primary", "ssn_mirror"], profileField: "ssn", fontSize: 10 },
  { id: "dl_number", label: "DL/State ID Number", type: "text", page: 1, xPct: 0.6536, yPct: 0.5802, section: "Application", fontSize: 10 },
  { id: "dob", label: "Date of Birth", type: "text", page: 1, xPct: 0.1634, yPct: 0.5486, section: "Application", tags: ["dob_primary", "dob_mirror"], profileField: "date_of_birth", fontSize: 10 },
  { id: "certifications", label: "Certifications", type: "text", page: 1, xPct: 0.5686, yPct: 0.5183, section: "Application", fontSize: 10 },
  { id: "hours_sunday", label: "Hours NOT Available - Sunday", type: "text", page: 1, xPct: 0.4118, yPct: 0.441, section: "Availability", fontSize: 9 },
  { id: "hours_monday", label: "Monday", type: "text", page: 1, xPct: 0.7092, yPct: 0.441, section: "Availability", fontSize: 9 },
  { id: "hours_tuesday", label: "Tuesday", type: "text", page: 1, xPct: 0.1209, yPct: 0.4094, section: "Availability", fontSize: 9 },
  { id: "hours_wednesday", label: "Wednesday", type: "text", page: 1, xPct: 0.4363, yPct: 0.4094, section: "Availability", fontSize: 9 },
  { id: "hours_thursday", label: "Thursday", type: "text", page: 1, xPct: 0.7173, yPct: 0.4094, section: "Availability", fontSize: 9 },
  { id: "hours_friday", label: "Friday", type: "text", page: 1, xPct: 0.1062, yPct: 0.3778, section: "Availability", fontSize: 9 },
  { id: "hours_saturday", label: "Saturday", type: "text", page: 1, xPct: 0.4167, yPct: 0.3778, section: "Availability", fontSize: 9 },
  { id: "related_employees", label: "Related to current/former employees?", type: "text", page: 1, xPct: 0.049, yPct: 0.3223, section: "Application", fontSize: 9 },
  { id: "how_heard", label: "How did you hear about HCN?", type: "text", page: 1, xPct: 0.4902, yPct: 0.2592, section: "Application", fontSize: 9 },
  { id: "p1_signature", label: "Applicant Signature", type: "signature", page: 1, xPct: 0.2614, yPct: 0.0739, section: "Application", fontSize: 10 },
  { id: "p1_date", label: "Date (Page 1)", type: "date", page: 1, xPct: 0.634, yPct: 0.0739, section: "Application", tags: ["date_primary"], fontSize: 10 },
  ...
  // ============ PAGE 16 - W-4 Form ============
  { id: "w4_first_name", label: "First Name & Middle Initial", type: "text", page: 16, xPct: 0.1634, yPct: 0.8677, section: "W-4 Form – Step 1: Personal Info", fontSize: 9 },
  { id: "w4_last_name", label: "Last Name", type: "text", page: 16, xPct: 0.4575, yPct: 0.8677, section: "W-4 Form – Step 1: Personal Info", fontSize: 9 },
  { id: "w4_ssn", label: "Social Security Number", type: "text", page: 16, xPct: 0.8007, yPct: 0.8677, section: "W-4 Form – Step 1: Personal Info", tags: ["ssn_mirror"], profileField: "ssn", fontSize: 9 },
  { id: "w4_address", label: "Address", type: "text", page: 16, xPct: 0.1634, yPct: 0.8425, section: "W-4 Form – Step 1: Personal Info", profileField: "address", fontSize: 9 },
  { id: "w4_city_state_zip", label: "City, State, ZIP", type: "text", page: 16, xPct: 0.1634, yPct: 0.8122, section: "W-4 Form – Step 1: Personal Info", profileField: "city_state_zip", fontSize: 9 },
  { id: "w4_filing_status", label: "Filing Status (Single / Married filing jointly / Head of household)", type: "text", page: 16, xPct: 0.1634, yPct: 0.7907, section: "W-4 Form – Step 1: Personal Info", fontSize: 9, instructions: "Enter one: Single, Married filing jointly, or Head of household" },
  { id: "w4_step2_checkbox", label: "Step 2(c) – Two jobs total checkbox (enter X if applicable)", type: "text", page: 16, xPct: 0.9281, yPct: 0.4814, section: "W-4 Form – Step 2: Multiple Jobs", fontSize: 9, instructions: "If there are only two jobs total, enter X. Otherwise leave blank." },
  { id: "w4_step3a", label: "3(a) Qualifying children under 17 × $2,200", type: "text", page: 16, xPct: 0.8824, yPct: 0.393, section: "W-4 Form – Step 3: Dependents", fontSize: 9, instructions: "Multiply number of qualifying children under 17 by $2,200" },
  { id: "w4_step3b", label: "3(b) Other dependents × $500", type: "text", page: 16, xPct: 0.8824, yPct: 0.3677, section: "W-4 Form – Step 3: Dependents", fontSize: 9, instructions: "Multiply number of other dependents by $500" },
  { id: "w4_step3_total", label: "Step 3 Total (3a + 3b + other credits)", type: "text", page: 16, xPct: 0.8824, yPct: 0.3425, section: "W-4 Form – Step 3: Dependents", fontSize: 9, instructions: "Add 3(a) and 3(b) plus any other credits" },
  { id: "w4_step4a", label: "4(a) Other income (not from jobs)", type: "text", page: 16, xPct: 0.8824, yPct: 0.2844, section: "W-4 Form – Step 4: Other Adjustments", fontSize: 9, instructions: "Interest, dividends, retirement income, etc." },
  { id: "w4_step4b", label: "4(b) Deductions", type: "text", page: 16, xPct: 0.8824, yPct: 0.2465, section: "W-4 Form – Step 4: Other Adjustments", fontSize: 9, instructions: "Use Deductions Worksheet on page 4 if applicable" },
  { id: "w4_step4c", label: "4(c) Extra withholding per pay period", type: "text", page: 16, xPct: 0.8824, yPct: 0.2086, section: "W-4 Form – Step 4: Other Adjustments", fontSize: 9, instructions: "Additional tax to withhold each pay period" },
  { id: "w4_signature", label: "Employee Signature", type: "signature", page: 16, xPct: 0.1961, yPct: 0.1092, section: "W-4 Form – Step 5: Sign", fontSize: 10 },
  { id: "w4_date", label: "Date", type: "date", page: 16, xPct: 0.7925, yPct: 0.1092, section: "W-4 Form – Step 5: Sign", tags: ["date_mirror"], fontSize: 10 },

  // ============ PAGE 19 - I-9 Section 1 ============
  { id: "i9_last_name", label: "Last Name", type: "text", page: 19, xPct: 0.0637, yPct: 0.7566, section: "I-9 Form", fontSize: 9 },
  { id: "i9_first_name", label: "First Name", type: "text", page: 19, xPct: 0.3448, yPct: 0.7566, section: "I-9 Form", fontSize: 9 },
  { id: "i9_middle", label: "Middle Initial", type: "text", page: 19, xPct: 0.5915, yPct: 0.7566, section: "I-9 Form", fontSize: 9 },
  { id: "i9_other_names", label: "Other Last Names Used", type: "text", page: 19, xPct: 0.6928, yPct: 0.7566, section: "I-9 Form", fontSize: 9 },
  { id: "i9_address", label: "Address", type: "text", page: 19, xPct: 0.0637, yPct: 0.72, section: "I-9 Form", profileField: "address", fontSize: 9 },
  { id: "i9_apt", label: "Apt. Number", type: "text", page: 19, xPct: 0.3987, yPct: 0.72, section: "I-9 Form", fontSize: 9 },
  { id: "i9_city", label: "City", type: "text", page: 19, xPct: 0.4967, yPct: 0.72, section: "I-9 Form", profileField: "city", fontSize: 9 },
  { id: "i9_state", label: "State", type: "text", page: 19, xPct: 0.7435, yPct: 0.72, section: "I-9 Form", profileField: "state", fontSize: 9 },
  { id: "i9_zip", label: "ZIP Code", type: "text", page: 19, xPct: 0.8056, yPct: 0.72, section: "I-9 Form", profileField: "zip_code", fontSize: 9 },
  { id: "i9_dob", label: "Date of Birth", type: "text", page: 19, xPct: 0.0654, yPct: 0.6758, section: "I-9 Form", tags: ["dob_mirror"], profileField: "date_of_birth", fontSize: 9 },
  { id: "i9_ssn", label: "SSN", type: "text", page: 19, xPct: 0.2778, yPct: 0.6758, section: "I-9 Form", tags: ["ssn_mirror"], profileField: "ssn", fontSize: 9 },
  { id: "i9_email", label: "Email", type: "text", page: 19, xPct: 0.4951, yPct: 0.6758, section: "I-9 Form", profileField: "email", fontSize: 9 },
  { id: "i9_phone", label: "Phone", type: "text", page: 19, xPct: 0.7958, yPct: 0.6758, section: "I-9 Form", profileField: "phone", fontSize: 9 },
  { id: "i9_citizen", label: "1. A citizen of the United States", type: "checkbox", page: 19, xPct: 0.0729, yPct: 0.5887, section: "I-9 Form – Citizenship Status", instructions: "Check if you are a U.S. citizen", fontSize: 9 },
  { id: "i9_noncitizen_national", label: "2. A noncitizen national of the United States", type: "checkbox", page: 19, xPct: 0.0729, yPct: 0.5672, section: "I-9 Form – Citizenship Status", instructions: "Check if you are a noncitizen national", fontSize: 9 },
  { id: "i9_permanent_resident", label: "3. A lawful permanent resident", type: "checkbox", page: 19, xPct: 0.0729, yPct: 0.547, section: "I-9 Form – Citizenship Status", instructions: "Check if you are a lawful permanent resident", fontSize: 9 },
  { id: "i9_alien_reg_number", label: "Alien Reg. Number/USCIS Number (if #3)", type: "text", page: 19, xPct: 0.4902, yPct: 0.5458, section: "I-9 Form – Citizenship Status", fontSize: 9 },
  { id: "i9_authorized_alien", label: "4. An alien authorized to work", type: "checkbox", page: 19, xPct: 0.0729, yPct: 0.5256, section: "I-9 Form – Citizenship Status", instructions: "Check if you are an alien authorized to work", fontSize: 9 },
  { id: "i9_work_expiration", label: "Work Auth. Expiration Date (if #4)", type: "text", page: 19, xPct: 0.4869, yPct: 0.5243, section: "I-9 Form – Citizenship Status", instructions: "mm/dd/yyyy or N/A", fontSize: 9 },
  { id: "i9_alien_uscis", label: "Alien Reg. Number/USCIS Number", type: "text", page: 19, xPct: 0.2941, yPct: 0.4536, section: "I-9 Form – Document Numbers (if #3 or #4)", instructions: "Complete one of these three fields", fontSize: 9 },
  { id: "i9_i94_number", label: "Form I-94 Admission Number", type: "text", page: 19, xPct: 0.1552, yPct: 0.4208, section: "I-9 Form – Document Numbers (if #3 or #4)", fontSize: 9 },
  { id: "i9_foreign_passport", label: "Foreign Passport Number", type: "text", page: 19, xPct: 0.1961, yPct: 0.3879, section: "I-9 Form – Document Numbers (if #3 or #4)", fontSize: 9 },
  { id: "i9_country_issuance", label: "Country of Issuance", type: "text", page: 19, xPct: 0.2206, yPct: 0.369, section: "I-9 Form – Document Numbers (if #3 or #4)", fontSize: 9 },
  { id: "i9_signature", label: "Signature of Employee", type: "signature", page: 19, xPct: 0.1307, yPct: 0.3425, section: "I-9 Form – Employee Signature", fontSize: 9 },
  { id: "i9_date", label: "Today's Date", type: "date", page: 19, xPct: 0.6944, yPct: 0.3425, section: "I-9 Form – Employee Signature", tags: ["date_mirror"], fontSize: 9 },

  // ============ PAGE 22 - Background Check ============
  { id: "bg_last_name", label: "Last Name", type: "text", page: 22, xPct: 0.1029, yPct: 0.4549, section: "Background Check", fontSize: 9 },
  { id: "bg_first_name", label: "First Name", type: "text", page: 22, xPct: 0.3971, yPct: 0.4549, section: "Background Check", fontSize: 9 },
  { id: "bg_middle", label: "Middle Name", type: "text", page: 22, xPct: 0.5735, yPct: 0.4549, section: "Background Check", fontSize: 9 },
  { id: "bg_maiden", label: "Maiden Name", type: "text", page: 22, xPct: 0.6912, yPct: 0.4549, section: "Background Check", fontSize: 9 },
  { id: "bg_dob", label: "Date of Birth", type: "text", page: 22, xPct: 0.1029, yPct: 0.4107, section: "Background Check", tags: ["dob_mirror"], profileField: "date_of_birth", fontSize: 9 },
  { id: "bg_race", label: "Race", type: "text", page: 22, xPct: 0.2925, yPct: 0.4107, section: "Background Check", fontSize: 9 },
  { id: "bg_sex", label: "Sex", type: "text", page: 22, xPct: 0.4199, yPct: 0.4107, section: "Background Check", fontSize: 9 },
  { id: "bg_ssn", label: "Social Security Number", type: "text", page: 22, xPct: 0.5768, yPct: 0.4107, section: "Background Check", tags: ["ssn_mirror"], profileField: "ssn", fontSize: 9 },
  { id: "bg_dl", label: "Driver's License #", type: "text", page: 22, xPct: 0.1029, yPct: 0.3703, section: "Background Check", fontSize: 9 },
  { id: "bg_dl_state", label: "State of Issue", type: "text", page: 22, xPct: 0.4559, yPct: 0.3703, section: "Background Check", fontSize: 9 },
  { id: "bg_address", label: "Mailing Address", type: "text", page: 22, xPct: 0.1029, yPct: 0.3286, section: "Background Check", profileField: "address", fontSize: 9 },
  { id: "bg_city", label: "City", type: "text", page: 22, xPct: 0.4739, yPct: 0.3286, section: "Background Check", profileField: "city", fontSize: 9 },
  { id: "bg_state", label: "State", type: "text", page: 22, xPct: 0.5784, yPct: 0.3286, section: "Background Check", profileField: "state", fontSize: 9 },
  { id: "bg_zip", label: "ZIP Code", type: "text", page: 22, xPct: 0.8105, yPct: 0.3286, section: "Background Check", profileField: "zip_code", fontSize: 9 },
