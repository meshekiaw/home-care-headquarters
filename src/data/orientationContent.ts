...
export const orientationSections: OrientationSection[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Policies may be changed, modified, or updated by Home Care Network, LLC as needed.</li>
    ...
    quizQuestions: [
      ...
      {
        questionText: "What type of employment does Home Care Network, LLC practice?",
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Home Care Network, LLC is dedicated to competent, professional service for every client.</li>
  ...
  },
  {
    ...
    quizQuestions: [
      {
        questionText: "Hiring decisions at Home Care Network, LLC are based on:",
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Appropriate:</strong> Home Care Network, LLC T-shirt, scrubs, khaki pants, collared shirt, tennis shoes.</li>
    ...
    quizQuestions: [
      {
        ...
        options: ["Scrubs", "Khaki pants", "Flip flops", "Home Care Network, LLC T-shirt"],
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Do not provide unauthorized care without Home Care Network, LLC approval.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Home Care Network, LLC staff are <strong>not authorized to administer medication</strong>.</li>
    ...
    quizQuestions: [
      {
        questionText: "Can Home Care Network, LLC caregivers administer medication to clients?",
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>The handbook says Home Care Network, LLC does <strong>not allow hand-over-hand medication support</strong> under agency policy.</li>
