            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="form_618_date"
                  type="date"
                  value={formData.form_618_date}
                  onChange={(e) => handleChange("form_618_date", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="form_618_expiration_date">618 Expiration Date</Label>
                <Input
                  id="form_618_expiration_date"
                  type="date"
                  value={formData.form_618_expiration_date}
                  onChange={(e) => handleChange("form_618_expiration_date", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="authorization_begin_date">Authorization Begin Date</Label>
                <Input
                  id="authorization_begin_date"
                  type="date"
